  ...
  return (
    <>
      <Text>
        ...
        <Link href="TODO:" isExternal>blog post</Link>. */}
      </Text>
      <Accordion defaultIndex={[]} allowMultiple>
        <FAQItem title={"Why do I need to log in?"}>
          <Text>
        ...
        <FAQItem title={"How do you pronounce GeniE"}>
          <Text>Jee · nee</Text>
        </FAQItem>
        ...
        >
          <>
            ...
            <Text>
              ...
              performed by this tool is most accurately defined as an{" "}
              <strong>estimated genetic prevalence</strong>, as it represents
              the estimated proportion of a population that will have a genotype
              for a genetic disorder, irrespective of penetrance, age of onset,
              ...
              please see our FAQ "What factors should I consider when
              interpreting these results?" To read more about how these
        ...
        >
          <>
            <Text>
              ...
              proportion of a population that has a causal genotype for a
              specific genetic disorder, irrespective of whether these
              individuals will or will not manifest the disease. For instance,
              if the causative genotype is not fully penetrant, then the
              estimated genetic prevalence will be higher than actual disease
              prevalence. To learn more about the factors that shape the
              estimated genetic prevalence, please read “What factors should I
        ...
        >
          <>
            ...
            <Text>
              <em>Carrier frequency methods:</em>
            </Text>
            <Text>
            ...
            <Text>
              ...
              the formula: <Text ml={4}>AC - 2 * (# of homozygotes)</Text>
              <Text ml={8}>AC = allele count of a particular variant</Text>
            ...
            <Text>
              <em>Genetic prevalence methods:</em>
            </Text>
            <Text>
              <i>
            ...
            <Text>
              ...
              <Link to="https://pubmed.ncbi.nlm.nih.gov/25893794/" isExternal>
                PMID: 25893794
              </Link>
              )
              <Text ml={4}>
        ...
        <FAQItem title={"What types of variants does GeniE support?"}>
          <Text>
        ...
        <FAQItem title={"How do I add structural variants to a variant list"}>
          <Text>
            Currently, structural variants (SVs) can only be added via creation
            of a manual list, or by adding the variant manually after a
            recommended list is created.
          </Text>

          <Text>
            Please note: for gnomAD v2 SVs there are fewer genetic ancestry
            groups for both the non-Finnish european and Finnish ancestry groups
            are included in the "European" ancestry group. For the purposes of
            display in GeniE, we have included the v2 SV "European" gnetic
            ancestry group in the "European (non-Finnish)" group.
          </Text>
        </FAQItem>
        ...
        >
          <Text>
            ...
            prevalence can be calculated by observing carriers at expected rates
            in the general population, i.e., using the carrier frequency in
            unaffected individuals. In contrast, for dominant disorders,
            pathogenic variants are typically found in affected individuals who
            ...
            databases. As a result, this method does not work as well for many
            autosomal dominant conditions. For X-linked disorders in carrier
        ...
        <FAQItem title={"What version of gnomAD is used in GeniE?"}>
          <Text>
          ...
          <Text>
            ...
            v2.1.1 this method was not used, meaning that allele frequencies
            could look higher than they truly were. An example of this is if a
            variant was identified in one genome sample in v2, the allele
            frequency was reported as ~1/32,000 (0.00003) despite there being
            sufficient coverage in the exomes to show the variant was absent
            from the other ~220,000 alelles, and thus has a frequency closer to
            1/250,000 (0.000004)
          </Text>

          <Text>
            <em>Genetic ancestry subgroups:</em>
          </Text>
          <Text>
            Genetic ancestry subgroups (ex. Korean, Bulgariant, Estonian) are
        ...
        <FAQItem
          id="what-factors-should-i-consider-when-interpreting-these-results"
          title={
        ...
        >
          <>
            <Text mb={2}>
              ...
              prevalence. There are many factors that go into these estimates,
              which can influence the way you interpret the results.
            </Text>
            ...
            <UnorderedList spacing={2} mb={2}>
              <ListItem>
                ...
                frequencies for GeniE. Individuals with rare disease are less
                likely to participate in or meet recruitment criteria for
                research studies that are included in reference population
                databases. Depletion of symptomatic carriers could lower the
                allele frequencies of pathogenic variants observed in gnomAD.
              </ListItem>
              <ListItem>
                Impacts to life expectancy: Genetic prevalence represents the
                estimated proportion of a population that has a causal genotype
                for a genetic disorder, however it does not account for the
                possibility that specific allele combinations may lead to early
                misscarriage or neonatal loss. Some combinations could lead to
                loss of life early on, before the individual could be identified
                as having the clinical diagnosis.
              </ListItem>
              <ListItem>
                Reduced penetrance and variable expressivity: Similarly, the
                full phenotypic spectrum is still being discovered for many
                diseases. This final estimate does not currently take into
                consideration whether everyone with a casual genotype would
                present with the phenotype/disease of interest.
              </ListItem>
            </UnorderedList>
            ...
            <UnorderedList spacing={2} mb={2}>
              <ListItem>
                ...
                appear to be absent or rare in the population data.
              </ListItem>
              <ListItem>
                <em>
              ...
              <ListItem>
                <em>Is the disease-gene relationship still relatively new?</em>{" "}
            ...
            <UnorderedList spacing={2} mb={2}>
              ...
              <ListItem>
                ...
                based on a clinical diagnosis alone.
              </ListItem>
              <ListItem>
                <em>
        ...
        >
          ...
          <Text>
            ...
            reviewing the source data to determine if you feel the variant
        ...
        >
          <Text>
            ...
            add additional users. In order to be added as a user to the list,
            they must sign in using a Google authorized account.
          </Text>
          <UnorderedList>
            <ListItem>
            ...
            <ListItem>
              ...
              variant list and add private notes, but not will not be able to
              add any users or make a list public
            </ListItem>
            <ListItem>
        ...
        <FAQItem title={"What are public lists?"}>
          <Text>
            All new variant lists default to being a private list, only visible
            to the creator and any GeniE users that are given access by an
            owner. Users can choose to make their lists public, which allows any
            individual to have view-only access to their estimates.
          </Text>
          <Text>
            Variant list owners can also apply to have their variant list
            represented on GeniE's dashboard. After applying, a staff member
            must approve the list for it to be on the{" "}
